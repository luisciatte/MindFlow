...
public class UsuarioServlet extends HttpServlet implements Serializable {
    ...
    /**
     * Inicializa os DAOs utilizados pelo servlet.
     */
    public void init() {
    ...
    /**
     * Processa requisições GET baseando-se na URL solicitada.
     */
    ...
    /**
     * Realiza o login de um usuário, validando suas credenciais e configurando a sessão.
     */
    ...
    /**
     * Desbloqueia o usuário e permite a redefinição da senha.
     */
